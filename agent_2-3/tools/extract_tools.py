...
**Finding** — qualitative observations from physical exam, imaging, or functional tests (non-numeric)
  name: anatomical location or test name (≤6 words) | value: brief qualitative descriptor (≤8 words) | unit: ""
  ⚠ SKIP findings that are explicitly absent/negative (e.g. "no effusion", "without consolidation", "negative for X")
...
5. name must be ≤6 words; value must be ≤10 words for non-LabResult categories — never paste full sentences
6. SKIP any Finding or Symptom whose value starts with "no", "without", "absent", "negative", "not seen", "not identified" — these are negative findings and should be omitted entirely
