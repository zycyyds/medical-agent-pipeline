...
from agent_5.medical_column_selector.main import TaskDrivenColumnSelector
from agent_5.medical_column_selector.agents.task_planner import TaskPlannerAgent
...
def test_dynamic_term_profile_selects_task_columns_and_protects_mimic_core(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "agent_5.medical_column_selector.main.TermPlannerAgent",
